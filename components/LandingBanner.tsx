...
export default function LandingBanner() {
  return (
    <div className="absolute inset-0 flex items-center justify-center -mt-16 z-[1000] pointer-events-none">
      <div className="text-center px-8 inline-block">
        <div className="flex items-center justify-center gap-4 mb-4">
          <img
            ...
            style={{ filter: 'drop-shadow(4px 4px 12px rgba(0,0,0,0.8)) drop-shadow(0 0 40px rgba(0,0,0,0.6))' }}
          />
