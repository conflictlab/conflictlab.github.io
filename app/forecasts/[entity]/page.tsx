        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="bg-white/70 backdrop-blur-sm p-6 rounded-lg border border-gray-200 shadow-sm lg:col-span-7">
              ...
              <div className="prose prose-sm max-w-none text-gray-600 mt-4 text-justify">
                <p>
                  These scenarios are generated by identifying historical conflict patterns that most closely resemble the current situation in {entity.name}. Our model analyzes thousands of past conflict trajectories worldwide and clusters them based on similarity in dynamics, intensity, and contextual factors.
                </p>
                <p className="mt-2">
                  Each line represents a distinct scenario — a cluster of similar historical cases whose trajectories inform potential futures. The opacity of each line reflects its probability: more opaque lines indicate scenarios the model considers more likely given current conditions. The dashed red portions show projected paths over the next six months, while the solid gray segments show the observed historical pattern leading up to the present.
                </p>
                <p className="mt-2">
                  This approach captures the inherent uncertainty in conflict forecasting: rather than a single prediction, we present the range of plausible outcomes suggested by historical precedent.
                </p>
              </div>
            </div>
          </div>
